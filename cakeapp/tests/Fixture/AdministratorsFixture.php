...
class AdministratorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'role' => 1,
            'created' => '2016-09-14 09:17:27',
            'modified' => '2016-09-14 09:17:27'
        ],
    ];
}
