...
class AdvertisementsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'link' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'ucs2_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'images' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'display' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'display' => 1,
            'created' => '2016-09-14 09:24:50',
            'modified' => '2016-09-14 09:24:50',
            'status' => 1,
            'pos' => 1
        ],
    ];
