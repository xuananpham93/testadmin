...
<body>
  ...
  <footer>
    <script>
      function get_image(){
        var str = (document.getElementById('xFilePath').value);

        $('#showimage').html('<img width="400px" src="<?php echo DOMAIN ?>'+ str +'">');
      }
    </script>
  ...
  <script src="<?php echo DOMAINAD ?>/js/bootstrap.min.js"></script>
</body>
</html>
